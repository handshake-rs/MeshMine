...
def validate_schema_coordination() -> None:
    ...
    require_tokens(
        ...
        (
            ...
            "STAGED_NAME_NODE_READ_CACHE_LIMIT",
            "STAGED_STATE_POINT_READ_CACHE_LIMIT",
            "staging_overlay_caches_name_nodes_and_active_state_point_reads",
            ...
            "SegmentArchiveCompactionReport",
    ...
    require_tokens(
        ...
        (
            ...
            "scan_segment_prefix",
            "SegmentManifest",
            "open_at_committed_tail",
            "sync_data",
            "truncate_segment_to_committed_tail",
            "ChecksumMismatch",
            "torn_tail",
            ...
            "begin_rewrite",
            "install_rewrite",
            "remove_other_archive_generations",
    ...
    require_tokens(
        ...
        (
            ...
            "incremental_builder_assigns_stable_slots_and_returns_full_record",
            "page_appender_publishes_only_the_synced_manifest_tail",
    ...
    require_tokens(
        node_source,
        (
            "HSRD_DIAGNOSTIC_API_VERSION: u32 = 11",
            ...
            "stage_prune_payload_height",
            "blocks_pruned_through",
            "compact_pruned_payload_segments_if_due",
...
def validate_consensus_boundaries() -> None:
    ...
    require_tokens(
        ...
        (
            ...
            "BlockSigopsExceeded",
            "prefetch_block_utxos",
            "block_utxos_are_prefetched_in_one_storage_batch",
            "MUTATION_MULTI_GET_THRESHOLD: usize = 2",
    ...
    require_tokens(
        ...
        (
            ...
            "validate_stored_activation",
            "stored_activation_rebinds_durable_status_to_body_commitments",
    ...
    require_tokens(
        ...
        (
            ...
            "pub fn reachable_record_roots_batched",
            "pub struct ReachableRecordRoots",
            "pub fn update_record_tree_batched",
    ...
    require_tokens(
        ...
        (
            ...
            "pub fn compact_name_tree_nodes_streaming",
...
def validate_shadow_sync() -> None:
    ...
    require_tokens(
        ...
        (
            ...
            "One atomic slice per scheduler turn",
            "active_state_work_ready",
            "active_state_cadence_runs_only_for_a_distinct_stored_frontier",
