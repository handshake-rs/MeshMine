...
| Native HSRD workspace | Locked formatting, strict all-target/all-feature Clippy, 379 all-feature tests, 370 no-default-feature tests, optimized all-target/all-feature build, and the complete pinned-HSD source handoff | Pass (updated 2026-07-22) |
