...
| Native HSRD workspace | Locked formatting, strict all-target/all-feature Clippy, 382 all-feature tests, 373 no-default-feature tests, optimized all-target/all-feature build, and the complete pinned-HSD source handoff | Pass (updated 2026-07-22) |
